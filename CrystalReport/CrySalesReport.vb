...
Public Class CrySalesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BikeShop.CrySalesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrySalesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrySalesReport = New CrySalesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
